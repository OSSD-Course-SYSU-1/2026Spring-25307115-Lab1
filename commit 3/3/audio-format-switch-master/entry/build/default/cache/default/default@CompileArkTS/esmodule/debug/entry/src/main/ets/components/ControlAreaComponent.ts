...
export class ControlAreaComponent extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__isWearable = new SynchedPropertySimpleOneWayPU(params.isWearable, this, "isWearable");
    ...
    updateStateVars(params: ControlAreaComponent_Params) {
        ...
        this.__isWearable.reset(params.isWearable);
    }
    ...
    private __isWearable: SynchedPropertySimpleOneWayPU<boolean>;
    get isWearable() {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.fontSize(this.isWearable ? 12 : 16);
            Button.width(this.isWearable ? 70 : 100);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.fontSize(12);
            // 流转按钮
            Button.width(this.isWearable ? 50 : 60);
            // 流转按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.margin({
                top: this.isWearable ? 12 : 24,
                bottom: this.isWearable ? 8 : 12
            });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Slider.create({
            ...
            Slider.height(this.isWearable ? 12 : 16);
            Slider.margin({
                left: -4,
                right: -4
            });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontSize(this.isWearable ? 9 : 10);
            Text.fontFamily(this.isWearable ? '' : 'HarmonyHeiTi');
            Text.lineHeight(this.isWearable ? '12vp' : '14vp');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            // 音频频谱可视化（手表端隐藏）
            if (this.showSpectrum && !this.isWearable) {
                this.ifElseBranchUpdateFunction(0, () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            __Image__controlImageBuilder();
            Image.width(this.isWearable ? 48 : 72);
            Image.onClick(() => {
                if (this.isPlay) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.width('100%');
            // 播放速度和播放模式控制（手表端精简）
            Row.margin({ top: this.isWearable ? 8 : 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 播放速度控制
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            // 音频信息弹窗（手表端隐藏）
            if (this.showAudioInfo && this.audioInfo && !this.isWearable) {
                this.ifElseBranchUpdateFunction(0, () => {
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new EqualizerComponent(this, { imageColor: this.imageColor }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/components/ControlAreaComponent.ets", line: 263, col: 9 });
